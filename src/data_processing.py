...
class DataProcessing:
    def __init__(self, input_path, output_path):
        ...
        logger.info("Data Processing has been initialized you bonehead...")

    def load_data(self):
        try:
            self.df = pd.read_csv(self.input_path)
            logger.info("Data loaded successfully you fool")
        except Exception as e:
            logger.error(f"Error while loading the data {e}")
            raise CustomException("Failed to load daata")
    ...
    def preprocess_data(self):
        try:
            ...
            logger.info("Basic processing done, finally.")
    ...
    def feature_selection(self):
        try: 
            ...
            logger.error(f"Error while feature_selection process {e}")
            raise CustomException("Failed in the feature selection process 'jerkoff'.")
    ...
    def save_data_and_scaler(self, X_train, X_test, y_train, y_test):
        try:
            ...
            logger.info("All this saving bullshit is done")

        except Exception as e:
            logger.info(f"Error while saving the {e}")
    ...
    def run(self):
        ...
        logger.info("Data processing is completed you moron.")
